...
See [challenge-01-juice-comparison-video.md](../04-challenges/challenge-01-juice-comparison-video.md) for the full spec. The short version:
...
- This week's [Lecture 1](../02-lecture-notes/01-what-makes-a-game-feel-good.md) and [Lecture 2](../02-lecture-notes/02-the-four-lenses-and-the-MDA-framework.md).
- The week's [exercises](../03-exercises/) — copy from them.
- The week's [challenge](../04-challenges/challenge-01-juice-comparison-video.md) — the recording recipe is there.
