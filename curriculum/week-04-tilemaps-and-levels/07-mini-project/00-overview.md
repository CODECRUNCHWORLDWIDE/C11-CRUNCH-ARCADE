...
- This week's [Lecture 1](../02-lecture-notes/01-the-tilemap-data-format.md) and [Lecture 2](../02-lecture-notes/02-camera-and-off-screen-culling.md).
- The week's [exercises](../03-exercises/) — copy from them.
- The week's [challenge](../04-challenges/challenge-01-3-loadable-levels.md) — the level-select pattern is there.
