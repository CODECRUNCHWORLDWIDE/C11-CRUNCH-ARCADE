...
- Your own [Lecture 1](../02-lecture-notes/01-the-game-loop-and-why-it-exists.md) and [Lecture 2](../02-lecture-notes/02-delta-time-and-the-fixed-timestep.md).
- The week's [exercises](../03-exercises/) — copy from them, that's why they exist.
