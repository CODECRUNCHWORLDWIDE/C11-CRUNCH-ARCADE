...
| [resources.md](./01-resources.md) | Pygame docs, free Game Programming Patterns chapters, Coding Train videos |
| [lecture-notes/01-the-game-loop-and-why-it-exists.md](./02-lecture-notes/01-the-game-loop-and-why-it-exists.md) | What a game loop is and why every engine has one |
| [lecture-notes/02-delta-time-and-the-fixed-timestep.md](./02-lecture-notes/02-delta-time-and-the-fixed-timestep.md) | Why "N pixels per frame" is a bug, and what to do instead |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of short coding drills |
| [exercises/exercise-01-blank-window.py](./03-exercises/exercise-01-blank-window.py) | Open a Pygame window, fill it with a colour, quit cleanly |
| [exercises/exercise-02-moving-circle.py](./03-exercises/exercise-02-moving-circle.py) | A circle that crosses the screen using delta time |
| [exercises/exercise-03-keyboard-input.py](./03-exercises/exercise-03-keyboard-input.py) | Move the circle with WASD |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-bouncing-ball.md](./04-challenges/challenge-01-bouncing-ball.md) | A circle that bounces off all four edges, with a twist |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the "Crunch Dot" moving-circle mini-game |
