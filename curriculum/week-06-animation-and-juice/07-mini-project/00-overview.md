...
1. Stage canonical start position and document the input sequence (see [Challenge 1](../04-challenges/challenge-01-before-after-juice-comparison.md) for the recipe).
...
- This week's [Lecture 1](../02-lecture-notes/01-sprite-sheet-animation.md) and [Lecture 2](../02-lecture-notes/02-tweening-easing-and-juice.md).
- The week's [exercises](../03-exercises/) — copy from them.
- The week's [challenge](../04-challenges/challenge-01-before-after-juice-comparison.md) — the side-by-side video is the deliverable.
