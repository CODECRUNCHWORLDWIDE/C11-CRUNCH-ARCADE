...
- Your own [Lecture 1](../lecture-notes/01-aabb-collision-and-rectangles.md) and [Lecture 2](../lecture-notes/02-velocity-gravity-and-the-bouncing-ball.md).
- The week's [exercises](../exercises/) — copy from them.
- The week's [challenge](../challenges/challenge-01-brick-breaker.md) — *especially* the hints.
